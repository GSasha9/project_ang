...
import { loadingStateInterceptor } from './shared/interceptors/loading-state-interceptor/loading-state-interceptor';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideHttpClient(
      withFetch(),
      withInterceptors([cacheInterceptor, errorHandlingInterceptor, loadingStateInterceptor]),
    ),
  ],
};
